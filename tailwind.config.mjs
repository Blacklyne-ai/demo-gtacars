...
// GTA Cars Dubai — cinematic dark-luxury dealer CI.
//   Palette is pixel-derived from the logo: brass/olive-gold emblem (#AB9C34 core
//   cluster) on transparent. System = deep cinematic black + warm ivory text +
//   a single restrained brass-gold accent (used sparingly: AED prices, CTAs,
//   hairline highlights). Single source of truth for values: src/styles/global.css
//   :root (RGB triplets, for Tailwind alpha support).
//   Fonts: Sora (display, architectural) + Inter (UI / specs / AED prices).
export default {
  ...
  theme: {
    extend: {
      colors: {
        ...
        gold: {
          DEFAULT: 'rgb(var(--rgb-gold) / <alpha-value>)',   // #C2AE4A brass accent (logo-bright)
          lite: 'rgb(var(--rgb-gold-lite) / <alpha-value>)', // #DCCB72 highlight / shimmer
          deep: 'rgb(var(--rgb-gold-deep) / <alpha-value>)', // #AB9C34 logo-true core, borders/hover
        },
      },
      fontFamily: {
